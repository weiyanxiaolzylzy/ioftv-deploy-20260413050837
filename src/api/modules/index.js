...
export const paramType ={
    'big1':"/bigscreen/countUserNum", //今日产能
    'big2':"/bigscreen/countDeviceNum", //设备总览 
    'big3':"/bigscreen/sbtx", //今日排班
    'big4':"/bigscreen/alarmNum", //本月标兵
    'big5':'/bigscreen/ssyj',//设备维修 
    'big6':'/bigscreen/installationPlan',// 装配计划
    'big7':'/bigscreen/ranking',// 本月生产排名
    'big8':'/bigscreen/centermap',// 构件供给图
